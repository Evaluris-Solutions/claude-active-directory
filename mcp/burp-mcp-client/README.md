...
Connect **Claude Active Directory** to PortSwigger's official Burp Suite MCP server for HTTP(S) visibility on in-scope surfaces (e.g. OWA, AD FS, certificate enrollment web). Authorized testing only.
