...
"""
Brain — Multi-Provider LLM Reasoning Layer for AD / Internal Pentest Workflows
...
You are a technical assistant to a security researcher conducting authorized internal and Active Directory security assessments.
...
6. IF IT FAILS — What that tells me and what to try instead"""
    ...
    def watchdog_diagnose(self, phase: str, pid: int, stale_secs: int,
        ...
        # ── 5. LLM diagnosis ─────────────────────────────────────────────────
        prompt = f"""You are the brain of an authorized Active Directory security assessment workflow.
